...
namespace Ecommerce.Api.Customers.Providers
{
    public class CustomersProvider : ICustomersProvider
    {
        ...
        Task<(bool IsSuccess, IEnumerable<Customer> Customers, string ErrorMessage)> ICustomersProvider.GetCustomersAsync()
        {
            throw new NotImplementedException();
        }

        Task<(bool IsSuccess, Customer Customer, string ErrorMessage)> ICustomersProvider.GetCustomerAsync(int id)
        {
            throw new NotImplementedException();
        }
    }
